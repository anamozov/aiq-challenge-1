"""
opencv based algorithms for circle detection
"""
...
def segment_circles_and_mask(image_bgr):
    """
    Detect circular objects in an image using computer vision techniques.
    
    This function uses multiple approaches to detect circular objects robustly:
    1. Contour-based detection with circularity filtering
    2. HoughCircles detection
...
def create_combined_image(image_bgr, mask, circles=None):
    """
