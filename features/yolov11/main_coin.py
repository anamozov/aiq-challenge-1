"""
YOLOv11 Coin Detection Training and Testing Script

This script is derived from the following open-source repositories:
...
# Ensure relative paths (e.g., utils/, weights/, Dataset/) resolve against this package directory
...
def main():
	...
	parser.add_argument('--batch-size', default=16, type=int)  # Reduced batch size for coin dataset
	parser.add_argument('--local-rank', default=0, type=int)
	parser.add_argument('--local_rank', default=0, type=int)
	parser.add_argument('--epochs', default=100, type=int)  # Reduced epochs for coin dataset
	parser.add_argument('--train', action='store_true')
	parser.add_argument('--test', action='store_true')
	parser.add_argument('--export-torchscript', action='store_true', help='Export best.pt to TorchScript format')
	...
	# Use coin-specific configuration
	with open('utils/coin_args.yaml', errors='ignore') as f:
